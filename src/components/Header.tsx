    ...
    <header className="sticky top-0 z-50 h-14 border-b border-white/[0.06] bg-[#0b0b0f] sm:h-16">
      <div className="mx-auto flex h-full max-w-6xl items-center justify-between px-3 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/girls"
            className="hidden h-8 items-center justify-center rounded-full border border-white/[0.12] bg-white/[0.04] px-3.5 text-[0.6rem] font-medium text-white/70 transition hover:bg-white/[0.08] sm:inline-flex sm:text-xs"
          >
            Iniciar sesión
          </Link>
          <Link
            href="/girls"
            className="flex h-8 items-center justify-center rounded-full bg-gradient-to-r from-[#ff3b7f] to-[#ff7a3d] px-3.5 text-[0.6rem] font-bold text-white shadow-[0_0_20px_rgba(255,59,127,0.35)] transition hover:shadow-[0_0_28px_rgba(255,59,127,0.5)] sm:px-4 sm:text-xs"
          >
