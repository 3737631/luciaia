      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ position: "relative", flex: 1, height: 41, minWidth: 0 }}>
              <div style={{
              ...
              <input ref={hiddenInputRef}
                ...
                onFocus={() => { setIsComposerFocused(true); requestAnimationFrame(() => window.scrollTo(0, 0)); }}
