...
export default function GirlCard({ girl }: { girl: Girl }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[420px] overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.06] shadow-2xl transition-all duration-300 hover:border-white/20 hover:shadow-[0_25px_80px_rgba(255,45,180,0.18)]">
