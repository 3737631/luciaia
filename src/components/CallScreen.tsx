      ...
      >
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
                ...
                >
                  ...
                  {videoLockedOnce && (
                    ...
                    >
                      <LockIcon size={15} stroke="#FF8FB3" />
                    </span>
                  )}
                </button>
                <span style={{ fontSize: 13, fontWeight: 450, color: "rgba(255,255,255,0.70)", lineHeight: 1 }}>
        ...
        {videoBlurred && (
          ...
          >
            ...
            <svg viewBox="0 0 24 24" width="clamp(42px, 12vw, 54px)" height="clamp(42px, 12vw, 54px)" fill="none" stroke="#FF5798" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{ opacity: 0.95 }}>
              <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
              <path d="M7 11V7a5 5 0 0 1 10 0v4" />
            </svg>
            <span style={{ fontSize: "clamp(18px, 5vw, 21px)", fontWeight: 800, color: "#fff", letterSpacing: "-0.01em", textShadow: "0 2px 10px rgba(0,0,0,.5)" }}>
              Continuar la videollamada
            </span>
            <span style={{ fontSize: "clamp(12.5px, 3.6vw, 13.5px)", lineHeight: 1.45, color: "rgba(255,255,255,.78)", textShadow: "0 1px 6px rgba(0,0,0,.5)", maxWidth: "min(300px, 84vw)" }}>
              La videollamada completa es exclusiva de Premium.
            </span>
            <button
              onClick={() => router.push("/premium")}
              style={{
                marginTop: 6, padding: "clamp(11px 22px, 3vw, 13px 30px)", borderRadius: 999,
                border: 0, cursor: "pointer",
                background: "linear-gradient(135deg,#FF5798,#FF6AA5)",
                color: "#fff", fontWeight: 700, fontSize: "clamp(14px, 4vw, 15px)",
                boxShadow: "0 8px 28px rgba(255,87,152,.45)",
                fontFamily: "inherit", whiteSpace: "nowrap", maxWidth: "84vw",
              }}
            >
              Hazte Premium
            </button>
