...
export default function ChicosPage() {
  ...
  useEffect(() => {
    ...
    const critical = [
      ...
      ...maleChars.slice(0, 8).map(g => getGirlImage(g.id, null, null, null, g.cloudinaryImage)),
    ];
    maleChars.slice(0, 8).forEach(g => {
    ...
    femaleGirls.slice(0, 4).forEach(g => otherImages.push(getGirlImage(g.id, null, null, null, g.cloudinaryImage)));
      ...
      <main style={{ minHeight: "100vh", maxWidth: 1200, margin: "0 auto", padding: "0 var(--container-padding)" }}>
        <div className="fantasy-creator">
          ...
          <div className="fantasy-creator__content">
            ...
            <p className="fantasy-creator__description">Diseña tu chico ideal con IA y pásalo bien con él</p>
          </div>
