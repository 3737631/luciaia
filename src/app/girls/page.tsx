  ...
  return (
    <>
      ...
      <main style={{ minHeight: "100vh" }}>
        ...
        {/* Create your AI */}
        <section className="container-nuvia" style={{ paddingTop: 22, paddingBottom: 2 }}>
          <div
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ position: "relative", width: 36, height: 30 }}>
                  {["luna", "nia", "vera"].map((id, i) => (
                    <div
                      key={id}
                      style={{
                        position: "absolute", left: i * 11, top: i === 2 ? 6 : 0,
                        width: 22, height: 22, borderRadius: "50%", overflow: "hidden",
                        border: "0.5px solid rgba(255,255,255,0.08)", zIndex: 3 - i,
                      }}
                    >
                      <img src={getGirlImage(id)} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                    </div>
                  ))}
                </div>
                <div>
                  <h3 style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "-0.02em", margin: 0, color: "var(--text)" }}>
