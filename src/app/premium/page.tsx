...
const plans = [
  {
    ...
    features: [
      ...
      "20 mensajes gratis al día",
      "1 minuto de llamada al día",
      "Historias de todas las chicas",
      "Directos con vista previa (5s)",
      "Videollamada con vista previa (2s)",
  ...
  },
  {
    ...
    features: [
      ...
      "Llamadas y videollamadas sin límite",
      "Directos completos, sin borrones",
      "Fotos y reacción a tus fotos",
      "Notas de voz",
      "Respuestas más largas",
      "Crea chicas sin límite",
    ],
    cta: "Hacerme Premium",
    href: "/girls",
  },
