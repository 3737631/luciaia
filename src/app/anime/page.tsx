...
export default function AnimePage() {
  ...
  useEffect(() => {
    ...
    const critical = [
      ...
      ...animeChars.slice(0, 8).map(g => getGirlImage(g.id, null, null, null, g.cloudinaryImage)),
    ];
    animeChars.slice(0, 8).forEach(g => {
      ...
      <main style={{ minHeight: "100vh", maxWidth: 1200, margin: "0 auto", padding: "0 var(--container-padding)" }}>
        ...
        <section className="fantasy-creator">
          ...
          <div className="fantasy-creator__copy">
            ...
            <p>Diseña tu personaje ideal con IA y pásalo bien.</p>
          </div>
